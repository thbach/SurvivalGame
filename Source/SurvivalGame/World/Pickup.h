...
public:
	...
	void InitializedPickup(const TSubclassOf<class UItem> ItemClass, const int32 Quantity);
...
protected:
	...
	// The item that will be added to the inventoryh when this pickup is taken
	...
	// if some property on the item is modified, we bind this to OnItemModified and refresh the UI
	UFUNCTION()
	void OnItemModified();
